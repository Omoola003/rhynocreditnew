...
export default function FeaturesSection() {
  ...
  return (
    <section className="w-[90%] md:w-[85%] mx-auto mt-20 md:mt-28 grid grid-cols-1 md:grid-cols-2 items-center gap-16">
      {/* Left: Text Content */}
      <motion.div
      ...
      >
        <div>
          <h2 className="text-3xl md:text-4xl font-bold text-[#052D1B] leading-snug mb-4">
        ...
        <div className="flex flex-col space-y-5">
          {features.map(feature => (
            <motion.div
              key={feature.title}
              whileHover={{ x: 6 }}
              className="flex items-center text-[#010B07] font-semibold text-lg cursor-pointer group"
            >
              ...
              <ChevronRight
                size={20}
                className="ml-2 text-gray-400 group-hover:text-[#39B44A] transition-colors duration-200"
              />
            </motion.div>
          ))}
        </div>
      ...
      >
        {/* Top Left */}
        <div className="rounded-2xl overflow-hidden h-[160px] md:h-[180px] hover:scale-[1.02] transition-transform duration-300">
          <Image
        ...
        <div className="row-span-2 rounded-2xl overflow-hidden h-[320px] md:h-[380px] hover:scale-[1.02] transition-transform duration-300 shadow-[0_4px_12px_rgba(0,0,0,0.08)]">
          <Image
        ...
        {/* Bottom Left */}
        <div className="rounded-2xl overflow-hidden h-[140px] md:h-[160px] hover:scale-[1.02] transition-transform duration-300">
          <Image
