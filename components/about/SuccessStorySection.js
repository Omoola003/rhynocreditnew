      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-10 md:gap-16 px-4 sm:px-6 lg:px-10">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center md:justify-start gap-5 sm:gap-8">
            ...
            <Link
              href="/contact"
              className="flex items-center gap-2 text-[#39B44A] font-semibold text-base sm:text-lg hover:text-black transition-colors duration-300"
            >
              Contact Us
        ...
        <motion.div
          ...
          transition={{ duration: 0.8, ease: 'easeOut' }}
        >
          <div className="relative w-full max-w-[400px] sm:max-w-[460px] aspect-[4/5] rounded-2xl overflow-hidden">
            <Image
