    ...
    <section className="w-[90%] md:w-[85%] mx-auto grid grid-cols-1 md:grid-cols-[30%_5%_65%] items-center mt-10 md:mt-20 pb-10">
      ...
      >
        <h1 className="text-4xl md:text-5xl font-bold text-[#010B07] leading-tight">
          ...
          <span className="text-[#052D1B]"> Your partner for growth.</span>
        </h1>
        ...
        <Link
          href="/apply"
          className="inline-flex items-center justify-between bg-white rounded-full shadow-[0_4px_8px_rgba(0,0,0,0.1)] px-6 py-4 w-[280px] hover:shadow-md transition"
        >
          <span className="text-[#010B07] font-medium">Apply for a loan</span>
